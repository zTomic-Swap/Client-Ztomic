            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Input
                    type="text"
                    placeholder={`Hashlock Nonce (initiator only)`}
                    value={hashlockNonce}
                    onChange={(e) => setHashlockNonce(e.target.value)}
                    disabled={isLoading}
                    className="bg-secondary border-border text-foreground"
                  />
                  <Input
                    type="text"
                    placeholder={`Order Id Hash (initiator only)`}
                    value={orderIdHash}
                    onChange={(e) => setOrderIdHash(e.target.value)}
                    disabled={isLoading}
                    className="bg-secondary border-border text-foreground"
                  />
                </div>
